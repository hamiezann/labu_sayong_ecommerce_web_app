...
$staff_lists = mysqli_query($conn, "SELECT * FROM users WHERE role = 'staff' ORDER BY FullName DESC");
...
if (isset($_GET['delete'])) {
    ...
    $action = mysqli_real_escape_string($conn, "Deleted staff: $name");
    mysqli_query($conn, "INSERT INTO logs (user_id, action) VALUES ('$uid', '$action')");

    $_SESSION['success_message'] = "🗑️ Staff '$name' deleted successfully with related data!";
    header("Location: manage-staff.php");
    exit();
}
